...
public class App 
{
    public static void main( String[] args )
    {
        ...
        System.out.println("Сумма массива 2 и 3 => " + addingArrays(array1, array3));
    }
    ...
    public static List<Integer> addingArrays(Integer[] arr1, Integer[] arr2) {
        ...
        if (arr1.length == arr2.length) {
            ...
            System.out.println("Сложение массивов не возможно. Разные длины массивов.");
            throw new RuntimeException("Сложение массивов не возможно. Разные длины массивов!");
        }
        return result;
    }
}
